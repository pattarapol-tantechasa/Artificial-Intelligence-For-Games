...
class GameWindow(pyglet.window.Window):
	...
	def __init__(self, **kwargs):
		...
		self.labels = {
			...
			'legend_ground': pyglet.text.Label('● Ground Agent', x=620, y=self.height-20, color=COLOUR_NAMES['RED']),
			'legend_flying': pyglet.text.Label('● Flying Agent', x=760, y=self.height-20, color=COLOUR_NAMES['BLUE']),
		}
