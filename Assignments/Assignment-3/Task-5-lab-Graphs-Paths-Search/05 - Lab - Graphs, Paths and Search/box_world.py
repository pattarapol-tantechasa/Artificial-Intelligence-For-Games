...
box_types = {
	"CLEAR":{"symbol":'.', "cost":{"CLEAR":1, "MUD":2, "WATER":5, "FOREST":2, "HILL":3}, "colour":"WHITE"},
	"MUD":{"symbol":'m', "cost":{"CLEAR":2, "MUD":4, "WATER":9, "FOREST":3, "HILL":5}, "colour":"BROWN"},
	"WATER":{"symbol":'~', "cost":{"CLEAR":5, "MUD":9, "WATER":10, "FOREST":7, "HILL":8}, "colour":"AQUA"},
	"FOREST":{"symbol":'f', "cost":{"CLEAR":2, "MUD":3, "WATER":8, "FOREST":3, "HILL":5}, "colour":"DARK_GREEN"},
	"HILL":{"symbol":'h', "cost":{"CLEAR":2, "MUD":4, "WATER":10, "FOREST":4, "HILL":7}, "colour":"ORANGE"},
