    ...
    def __init__(self, **kwargs):
        ...
        self.labels = {
            'mode': pyglet.text.Label(
                ...
                color=COLOUR_NAMES['WHITE'], font_size=14,
                multiline=True, width=self.width - 20,
                anchor_y='top'
            ),
            'status': pyglet.text.Label('', x=0, y=0, color=COLOUR_NAMES['WHITE'], font_size=14),
        }
        self._add_handlers()
...
settings = {
    ...
    'vsync': True,
    'resizable': False,
    'caption': "(Extensions) Soldier on Patrol - Task 16",
}
